  ...
  return (
    <div className="flex min-h-screen w-full flex-col group/design-root overflow-x-hidden scroll-smooth">
      ...
      <main className="flex-grow">
        ...
        <section
          id="services"
          className="py-12 bg-white dark:bg-background-dark border-b border-gray-100 dark:border-gray-800 scroll-mt-20"
        >
          <div className="px-4 max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <button
                  key={svc}
                  className="px-6 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-surface-dark hover:border-primary hover:text-primary transition-all text-sm font-medium flex items-center gap-2 shadow-sm"
                >
      ...
      <footer className="bg-white dark:bg-background-dark border-t border-gray-100 dark:border-gray-800 py-16">
        <div className="px-4 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">
            © 2024 FixIt Hawassa. Built for Hawassa residents.
          </p>
        </div>
      </footer>
    </div>
